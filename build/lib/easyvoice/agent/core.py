...
class VoiceAgent:
    ...
    def is_ready(self) -> bool:
        ...
        """
        return (self.memory is not None and 
    ...
    async def process_text_input(self, text: str) -> str:
        ...
        tools_used = await self._check_for_tools(text)
    ...
    async def start_conversation(self, push_to_talk: bool = False, verbose: bool = False) -> None:
    ...
    async def process_question(self, question: str, speak_response: bool = False, save_to_history: bool = True) -> str:
