...
class LLMInterface:
    ...
    async def _test_connection(self) -> None:
        ...
        try:
            ...
            raise ConnectionError(f"Cannot connect to Ollama at {self.settings.ollama_host}: {e}")
    ...
    async def generate_response(self, 
        ...
        try:
            ...
            response_task = asyncio.create_task(
                self._generate_response_async(messages)
            )
    ...
    def _prepare_messages(self, 
        ...
        messages.append({
            "role": "system",
            "content": "You are a helpful voice assistant. Respond conversationally and concisely."
        })
