...
class WhisperSTT:
    ...
    async def transcribe_audio_data(self, 
    ...
    def _transcribe_sync(self, audio_data: np.ndarray, options: Dict[str, Any]) -> Optional[str]:
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "languages": list(self.model.tokenizer.language_tokens.keys()) if hasattr(self.model.tokenizer, 'language_tokens') else []
        }
...
async def test_speech_recognition(settings: Settings,
                                duration: float = 3.0,
...
async def benchmark_stt_performance(settings: Settings,
